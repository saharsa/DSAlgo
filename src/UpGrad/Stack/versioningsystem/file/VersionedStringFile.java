package UpGrad.Stack.versioningsystem.file;


import UpGrad.Stack.versioningsystem.VersioningService;

/**
 * The VersionedStringFile implements the VersionedFile interface and makes use of the
 * {@link UpGrad.Stack.versioningsystem.VersioningService} to maintain file versions.
 *
 * This class uses the {@link UpGrad.Stack.versioningsystem.file.StringFile} as the concrete
